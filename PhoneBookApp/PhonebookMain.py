...
class Phonebook:
    ...
    def __init__(self):
        print("Welcome to PhoneBook Application This Application Is Developed By Mohanish.")
    ...
    def add_query(cls):
        ...
        if len(returned_number) > 0:
            print("Phone number Already Exists in the Phone Book")
        else:
            ...
            conn.commit()
            print("Contact with name: {} {} and Number: {} added Successfully!!!".format(first_name, last_name, phone_number))

    @classmethod
    def update_query(cls):
        print("Updating a number is not Allowed You can delete Number and can add new value.")

        phone_number = input("Enter Phone number: ")
        print("What Do you want to update [fn = First name/ ln = Last name ]")
        option = input().lower()
        ...
        if option == 'fn':
            ...
            try:
                ...
                print("Something Wrong happened while updating Data. please try again later")
                print(error)
            finally:
                cur.close()
                conn.close()
    ...
    def view_one_data(cls):
        print("On what data you want to find details[fn = First Name/ ln = Last Name / num = Number ]")
        option = input().lower()
    ...
    @classmethod
    def delete_data(cls):
        print("Contacts Can only be deleted using phone number!!!\n")
        phone_number = int(input("Enter phone Number: "))
